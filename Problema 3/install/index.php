<?php
/**
 * Instalador rápido de la aplicación "Nosecaen S.L."
 *
 * Lo que hace:
 *   1. Crea el fichero database/database.sqlite si no existe
 *      (o espera a que configures MySQL en .env manualmente).
 *   2. Copia .env.example a .env si no existe.
 *   3. Te muestra los comandos Artisan que tienes que ejecutar.
 *
 * Se puede acceder a este instalador navegando a:
