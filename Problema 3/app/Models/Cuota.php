...
/**
 * Modelo Eloquent para la entidad Cuota.
 *
 * Cada cuota es un cargo mensual (o excepcional) a un cliente.
 * Desde aquí se genera la factura PDF y se envía al cliente.
 *
 * @author  Alumno DWES
 * @version 1.0
 */
...
class Cuota extends Model
{
    ...
    /**
     * Listado paginado con cliente cargado.
     *
     * @param  int $porPagina
     ...
     *
     * @param  string|null $concepto Concepto que aparecerá en cada cuota.
